...
class LogReader:
    ...
    def prepare_to_divide_by_match(self, log):
        init_lines = list()
        total_matches = 0
    ...
    def divide_log_by_match(self, log, init_lines, total_matches):
        match_data_list = []
    ...
    # JSON similar format
    def create_ranking_dict(self, log_by_match, total_matches):
        ranking = dict()
        match = dict()
        for index in range(total_matches):
            total_kills = 0
    ...
    def add_score_to_ranking(self, ranking, log_by_match, total_matches):
        ranking_aux = dict()
        for index in range(total_matches):
    ...
    def create_ranking_by_death_dict(self, log_by_match, total_matches):
